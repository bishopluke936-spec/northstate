      ...
      >
        ...
        <div className="px-5 py-5 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-bold text-slate-900 leading-none tracking-tight">ALDER</p>
              <p className="text-xs text-slate-400 mt-0.5 leading-none">North State Senior Solutions</p>
            </div>
          </div>
          {onClose && (
            <button
